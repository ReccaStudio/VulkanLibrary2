...
namespace vks 
{
	...
	void UIOverlay::prepareResources()
	{
		...
		VkDescriptorSetLayoutCreateInfo descriptorLayout = vks::initializers::GenDescriptorSetLayoutCreateInfo(setLayoutBindings);
		...
		VkDescriptorImageInfo fontDescriptor = vks::initializers::GenDescriptorImageInfo(
			sampler,
			fontView,
			VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL
		);
		std::vector<VkWriteDescriptorSet> writeDescriptorSets = {
			vks::initializers::GenWriteDescriptorSet(descriptorSet, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 0, &fontDescriptor)
		};
	...
	void UIOverlay::preparePipeline(const VkPipelineCache pipelineCache, const VkRenderPass renderPass, const VkFormat colorFormat, const VkFormat depthFormat)
	{
		...
		VkPushConstantRange pushConstantRange = vks::initializers::GenPushConstantRange(VK_SHADER_STAGE_VERTEX_BIT, sizeof(PushConstBlock), 0);
		...
		VkPipelineRasterizationStateCreateInfo rasterizationState =
			vks::initializers::GenPipelineRasterizationStateCreateInfo(VK_POLYGON_MODE_FILL, VK_CULL_MODE_NONE, VK_FRONT_FACE_COUNTER_CLOCKWISE);
		...
		VkPipelineColorBlendStateCreateInfo colorBlendState =
			vks::initializers::GenPipelineColorBlendStateCreateInfo(1, &blendAttachmentState);

		VkPipelineDepthStencilStateCreateInfo depthStencilState =
			vks::initializers::GenPipelineDepthStencilStateCreateInfo(VK_FALSE, VK_FALSE, VK_COMPARE_OP_ALWAYS);

		VkPipelineViewportStateCreateInfo viewportState =
			vks::initializers::GenPipelineViewportStateCreateInfo(1, 1, 0);

		VkPipelineMultisampleStateCreateInfo multisampleState =
			vks::initializers::GenPipelineMultisampleStateCreateInfo(rasterizationSamples);
		...
		VkPipelineDynamicStateCreateInfo dynamicState =
			vks::initializers::GenPipelineDynamicStateCreateInfo(dynamicStateEnables);
		...
		std::vector<VkVertexInputAttributeDescription> vertexInputAttributes = {
			...
			vks::initializers::GenVertexInputAttributeDescription(0, 1, VK_FORMAT_R32G32_SFLOAT, offsetof(ImDrawVert, uv)),	// Location 1: UV
			vks::initializers::GenVertexInputAttributeDescription(0, 2, VK_FORMAT_R8G8B8A8_UNORM, offsetof(ImDrawVert, col)),	// Location 0: Color
		};
